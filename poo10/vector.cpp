...
public:
    ...
    return d; }
    bool operator<(const X&var){
        if(elem1<var.elem1)return 1;
        return 0;
    }
};
...
*/
     ...
     buf[2]="Cetos";
     buf[3]="Misty";
     pereche<string,string> *v;
     v=new pereche<string,string>[2];
     v[0]=pereche<string, string>(buf[0], buf[1]);
     v[1]=pereche<string, string>(buf[2], buf[3]);
     vector <pereche<string,string>> x(2, v);
     cout<<x<<endl;
     cout<<v[0]<<endl;
     cout<<v[1]<<endl;
